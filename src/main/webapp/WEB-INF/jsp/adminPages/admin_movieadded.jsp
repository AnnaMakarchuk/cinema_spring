...
<div class="w3-container w3-left-align">
    <div class="w3-container w3-center w3-text-teal">
        <h1><b><fmt:message key="add.movie.notice"/></b></h1>
    </div>

    <p> <div class="w3-bar w3-padding-large w3-padding-24">
            <button class="w3-btn w3-white w3-border w3-border-teal w3-round-large w3-left-align" onclick="location.href='/admincabinet'">
