...
<div class="w3-container w3-right-align">
    ...
    <c:choose>
                    ...
                    <c:when test="${user.role == administrator}">
                             ...
                             <button class="w3-button w3-teal w3-round-large w3-padding-large" style="width:50%" onclick="location.href='/admin/unactiveschedule'">
                                        <fmt:message key="non.active.schedule"/>
                             </button>

                             <button class="w3-button w3-teal w3-round-large w3-padding-large" style="width:50%" onclick="location.href='/admin/unactivemovies'">
